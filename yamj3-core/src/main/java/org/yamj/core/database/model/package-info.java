...
@TypeDefs({
    ...
    @TypeDef(name = "relationType", typeClass = EnumStringUserType.class,
    parameters = {@Parameter(name = "enumClassName", value = "org.yamj.core.database.model.type.RelationType")})
})
