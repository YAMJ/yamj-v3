...
@TypeDefs({
    ...
    @TypeDef(name = "participationType", typeClass = EnumStringUserType.class,
        parameters = {@Parameter(name = "enumClassName", value = "org.yamj.plugin.api.type.ParticipationType")}),
    @TypeDef(name = "imageType", typeClass = EnumStringUserType.class,
        parameters = {@Parameter(name = "enumClassName", value = "org.yamj.plugin.api.type.ImageType")}),
