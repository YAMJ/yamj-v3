...
public class ExtendedHibernateTemplate extends HibernateTemplate {
	 ...
	 * @param maxResults
	 *        number of maximal results to return
	 * @param readOnly
	 *        if query should be read only
	 ...
	 *        maximal number of results
	 * @param readOnly
	 *        if query should be done read-only
	 * @return the result list
	 * @throws DataAccessException
	 *         if an error occurred
	 */
	 ...
	 *        the query
	 * @param namedParams
	 *        the valueMap to set in the query
